...
export const StartCourse = ({idClass, idCourse, imageUrl, title}:IStartCourseProps) => {
    const { ref, inView, entry } = useInView({ threshold: 0.2, initialInView: true });
    ...
    return (
        <>
            <div ref={ref} className="p-3 bg-paper rounded-md flex flex-col gap-4">
                ...
                >
                    <div className="w-full h-full flex items-center justify-center bg-background rounded opacity-0 hover:opacity-70">
